...
/*Eliminar Tablas*/
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE TRANSACTIONPRODUCT';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE CARPRODUCT';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE DIRECTIONS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE PAYS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE BANKING_ENTITIES';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE PURCHASING_STATUS';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
-- Ahora creamos las tablas en el orden correcto
...
CREATE TABLE TRANSACTIONS (
    ...
    CONSTRAINT tr_direction_fk FOREIGN KEY (DIRECTION_ID) REFERENCES DIRECTIONS (DIRECTION_ID),
    CONSTRAINT tr_pay_fk FOREIGN KEY (PAY_ID) REFERENCES PAYS (PAY_ID)
);
...
DATAFILE 'C:\oraclexe\app\data_files\userdata.dbf'
SIZE 500M 
AUTOEXTEND ON 
NEXT 50M 
MAXSIZE 500M;
...
DATAFILE 'C:\oraclexe\app\data_files\productdata.dbf'
SIZE 500M 
AUTOEXTEND ON 
NEXT 50M 
MAXSIZE 500M;
...
DATAFILE 'C:\oraclexe\app\data_files\transactiondata.dbf'
SIZE 500M 
AUTOEXTEND ON 
NEXT 50M 
MAXSIZE 500M;
...
DATAFILE 'C:\oraclexe\app\data_files\cardata.dbf'
SIZE 500M 
AUTOEXTEND ON 
NEXT 50M 
MAXSIZE 500M;

-- Mover las tablas a los tablespaces correspondientes
...
ALTER TABLE PURCHASING_STATUS MOVE TABLESPACE TRANSACTION_DATA;
ALTER TABLE BANKING_ENTITIES MOVE TABLESPACE TRANSACTION_DATA;
ALTER TABLE ADMINISTRATORS MOVE TABLESPACE TRANSACTION_DATA;
ALTER TABLE NEWS MOVE TABLESPACE TRANSACTION_DATA;
...
BEGIN
    IF :NEW.USER_ID IS NULL THEN
        SELECT ORTEGON.USERS_SEQ.NEXTVAL INTO :NEW.USER_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.PRODUCT_ID IS NULL THEN
        SELECT ORTEGON.PRODUCTS_SEQ.NEXTVAL INTO :NEW.PRODUCT_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.PAY_ID IS NULL THEN
        SELECT ORTEGON.PAYS_SEQ.NEXTVAL INTO :NEW.PAY_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.DIRECTION_ID IS NULL THEN
        SELECT ORTEGON.DIRECTIONS_SEQ.NEXTVAL INTO :NEW.DIRECTION_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.TRANSACTION_ID IS NULL THEN
        SELECT ORTEGON.TRANSACTIONS_SEQ.NEXTVAL INTO :NEW.TRANSACTION_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.TP_ID IS NULL THEN
        SELECT ORTEGON.TRPR_SEQ.NEXTVAL INTO :NEW.TP_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.CAR_ID IS NULL THEN
        SELECT ORTEGON.CARS_SEQ.NEXTVAL INTO :NEW.CAR_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.CP_ID IS NULL THEN
        SELECT ORTEGON.CARPR_SEQ.NEXTVAL INTO :NEW.CP_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.ADMINISTRATOR_ID IS NULL THEN
        SELECT ORTEGON.ADMINISTRATORS_SEQ.NEXTVAL INTO :NEW.ADMINISTRATOR_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.DEPARTMENT_ID IS NULL THEN
        SELECT ORTEGON.DEPARTMENTS_SEQ.NEXTVAL INTO :NEW.DEPARTMENT_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.GENRE_ID IS NULL THEN
        SELECT ORTEGON.GENRES_SEQ.NEXTVAL INTO :NEW.GENRE_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.PURCHASING_STATUS_ID IS NULL THEN
        SELECT ORTEGON.PURCHASING_STATUS_SEQ.NEXTVAL INTO :NEW.PURCHASING_STATUS_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.BANKING_ENTITY_ID IS NULL THEN
        SELECT ORTEGON.BANKING_ENTITIES_SEQ.NEXTVAL INTO :NEW.BANKING_ENTITY_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.NEWS_ID IS NULL THEN
        SELECT ORTEGON.NEWS_SEQ.NEXTVAL INTO :NEW.NEWS_ID FROM DUAL;
    END IF;
END;
...
create or replace FUNCTION DIRECTION_LIST_MANAGEMENT(
    p_user_id NUMBER  -- El ID del usuario, que se recibir� siempre
) RETURN SYS_REFCURSOR
IS
    v_cursor SYS_REFCURSOR;
BEGIN
    -- Abrir un cursor para seleccionar todos los pagos donde ACTIVE sea igual a 1
    -- y el USER_ID sea el due�o del pago
    OPEN v_cursor FOR
    SELECT *
    FROM DIRECTIONS
    WHERE ACTIVE = 1
    AND USER_ID = p_user_id;  -- Compara si el ID que llega es del due�o del pago
...
create or replace FUNCTION GET_ALL_PRODUCTS(
    p_user_id NUMBER := NULL  -- Par�metro opcional, por defecto NULL
) RETURN SYS_REFCURSOR
IS
    v_cursor SYS_REFCURSOR;
BEGIN
...
BEGIN
    ...
    SELECT *
    FROM banking_entities
    WHERE ACTIVE = 1;  -- Compara si el ID que llega es del due�o del pago
    RETURN v_cursor; -- Retornar el cursor con los registros
EXCEPTION
    WHEN OTHERS THEN
        -- Manejo de otras excepciones
...
IS
    v_cursor SYS_REFCURSOR;
BEGIN
    -- Abrir un cursor con el registro del usuario que coincide por email y est� activo
    OPEN v_cursor FOR
    SELECT *
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        -- Manejo de excepci�n si no se encuentra el usuario
        RETURN NULL;
    WHEN OTHERS THEN
        -- Manejo de otras excepciones
        RAISE;
...
BEGIN
    -- Aseg�rate de usar un filtro que garantice una �nica fila
...
EXCEPTION
    ...
    WHEN TOO_MANY_ROWS THEN
        -- Maneja el caso en que se devuelvan m�ltiples filas (opcional)
        RETURN NULL;
    WHEN OTHERS THEN
        RAISE;
END GET_PASSWORD;
...
BEGIN
    ...
    FROM PRODUCTS p
    INNER JOIN USERS u ON u.user_id = p.user_id;  -- Compara si el ID que llega es del due�o del pago
    RETURN v_cursor; -- Retornar el cursor con los registros
EXCEPTION
    WHEN OTHERS THEN
        -- Manejo de otras excepciones
...
BEGIN
    ...
    FROM PRODUCTS p
    where user_id is null;  -- Compara si el ID que llega es del due�o del pago
    RETURN v_cursor; -- Retornar el cursor con los registros
EXCEPTION
    WHEN OTHERS THEN
        -- Manejo de otras excepciones
...
BEGIN
    ...
    OPEN v_cursor FOR
    SELECT *
    FROM USERS;  -- Compara si el ID que llega es del due�o del pago
    RETURN v_cursor; -- Retornar el cursor con los registros
EXCEPTION
    WHEN OTHERS THEN
        -- Manejo de otras excepciones
          ...
          AND (
              ...
              (p_user_id IS NOT NULL AND (
                  ...
                  (P.USER_ID IS NOT NULL AND P.USER_ID IN (
                      ...
                      FROM USERS U
                      WHERE U.USER_ID = p_user_id -- Par�metro del usuario actual
                  ))
              ))
          )
        ORDER BY P.CREATED_AT DESC
...
BEGIN
    ...
    AND cp.active = 1 AND c.active = 1;  -- Compara si el ID que llega es del due�o del pago
    RETURN v_cursor; -- Retornar el cursor con los registros
EXCEPTION
    WHEN OTHERS THEN
        -- Manejo de otras excepciones
...
BEGIN
    ...
    AND cp.active = 1 
    AND c.active = 1
    AND (p.user_id IS NULL OR u.user_id IS NOT NULL);  -- Condici�n: si el product no tiene user_id, no hacer JOIN
    RETURN v_cursor; -- Retornar el cursor con los registros
EXCEPTION
    WHEN OTHERS THEN
        -- Manejo de otras excepciones
...
BEGIN
    ...
    IF v_count > 0 THEN
        ...
        WHERE user_id = p_user_id AND name = p_name;
        COMMIT;
        RETURN 1; -- Retorna 1 si se actualiz� exitosamente
    ELSE
        ...
        COMMIT;
        RETURN 2; -- Retorna 2 si se insert� exitosamente
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        ROLLBACK;
...
BEGIN
    ...
    WHERE tp.seller_id = p_user_id;  -- Compara si el ID que llega es del due�o del pago
    RETURN v_cursor; -- Retornar el cursor con los registros
EXCEPTION
    WHEN OTHERS THEN
        -- Manejo de otras excepciones
...
BEGIN
    ...
    SELECT *
    FROM TRANSACTIONS_LIST
    WHERE buyer_id = p_user_id;  -- Compara si el ID que llega es del due�o del pago
    RETURN v_cursor; -- Retornar el cursor con los registros
EXCEPTION
    WHEN OTHERS THEN
        -- Manejo de otras excepciones
...
RETURN VARCHAR2 AS
BEGIN
    -- Construir la consulta din�mica para actualizar solo los campos no nulos
    UPDATE banking_entities
    SET 
...
INSERT INTO ADMINISTRATORS (ADMINISTRATOR_ID, EMAIL, ADMINISTRATOR_PASSWORD, CREATED_AT)
VALUES (
    1, -- ADMINISTRATOR_ID (asumiendo que es el primer administrador)
    'admin@gmail.com', -- EMAIL
    '123', -- ADMINISTRATOR_PASSWORD (debe ser cambiada despu�s de la primera conexi�n)
